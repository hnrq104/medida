...
\begin{proof}
    ...
    Se $||H||_p = \infty$, basta mostrar que em algum conjunto de $X_2$ de medida positiva, 
    \[
    \int_{X_1}f(x_1,x_2)^p d\mu_1 > 0 
    \]
    e a desigualdade valerá trivialmente. 
    Essa observação segue por contra-positiva e por Fubini, suponha que para todo conjunto de medida positiva 
    de $X_2$, $\int_{X_1}f(x_1,x_2)^p d\mu_1 = 0$,
    em particular 
    \[
    \int_{X_1} f(x_1,x_2) d\mu_1 = 0
    \]
    Por Fubini,
    \[
        ||f||_1 = \int_{X_1} \int_{X_2} |f| d\mu_2 d\mu_1= \int_{X_2} \int_{X_1} |f| d\mu_1 d\mu_2 = 0
    \]
    Logo $H = 0$ a.e. contradizendo a hipótese.
\end{proof}
